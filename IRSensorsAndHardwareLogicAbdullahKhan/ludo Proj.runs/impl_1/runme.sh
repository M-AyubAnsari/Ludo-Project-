...
HD_PWD='C:/Users/M Abdullah Khan/ludo Proj/ludo Proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLudoWithSensors.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLudoWithSensors.tcl -notrace
