...
HD_PWD='C:/Users/M Abdullah Khan/ludo Proj/ludo Proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLudoWithSensors.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLudoWithSensors.tcl
